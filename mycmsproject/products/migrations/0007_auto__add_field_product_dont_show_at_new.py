...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.dont_show_at_new'
        db.add_column('products_product', 'dont_show_at_new',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.dont_show_at_new'
        db.delete_column('products_product', 'dont_show_at_new')
    ...
    models = {
        ...
        'products.product': {
            ...
            'dont_show_at_new': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
