...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('products_category', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.name_tr'
        db.add_column('products_category', 'name_tr',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('products_category', 'name_en')

        # Deleting field 'Category.name_tr'
        db.delete_column('products_category', 'name_tr')
