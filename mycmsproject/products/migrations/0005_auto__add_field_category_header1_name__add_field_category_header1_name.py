...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('products_category', 'header1_name',
                      self.gf('django.db.models.fields.CharField')(default='Yuksel No', max_length=200, null=True, blank=True),
                      keep_default=False)
        ...
        db.add_column('products_category', 'header2_name',
                      self.gf('django.db.models.fields.CharField')(default='Image', max_length=200, null=True, blank=True),
                      keep_default=False)
        ...
        db.add_column('products_category', 'header3_name',
                      self.gf('django.db.models.fields.CharField')(default='OEM No', max_length=200, null=True, blank=True),
                      keep_default=False)
        ...
        db.add_column('products_category', 'header4_name',
                      self.gf('django.db.models.fields.CharField')(default='Description', max_length=200, null=True, blank=True),
                      keep_default=False)
