...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('products_product', 'brand_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column('products_product', 'brand',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['products.Brand']),
                      keep_default=False)
