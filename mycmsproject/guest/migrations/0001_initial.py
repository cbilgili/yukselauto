...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'guest.hello': {
            'Meta': {'object_name': 'Hello', 'db_table': "'cmsplugin_hello'", '_ormbases': ['cms.CMSPlugin']},
