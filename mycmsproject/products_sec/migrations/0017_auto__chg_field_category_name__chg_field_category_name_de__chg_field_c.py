...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('products_category', 'name', self.gf('django.db.models.fields.CharField')(max_length=150))

        # Changing field 'Category.name_de'
        db.alter_column('products_category', 'name_de', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'Category.name_tr'
        db.alter_column('products_category', 'name_tr', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'Category.name_en'
        db.alter_column('products_category', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'Category.name'
        db.alter_column('products_category', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Category.name_de'
        db.alter_column('products_category', 'name_de', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Category.name_tr'
        db.alter_column('products_category', 'name_tr', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Category.name_en'
        db.alter_column('products_category', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
