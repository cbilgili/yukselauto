...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('products_category', 'parent',
                      self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['products.Category']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('products_category', 'parent_id')
